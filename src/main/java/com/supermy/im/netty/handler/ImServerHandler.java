...
public class ImServerHandler extends ChannelInboundHandlerAdapter {
    ...
    private static Logger logger = Logger.getLogger(ImServerHandler.class.getName());
...
//        }
        ...
        incoming.writeAndFlush("[谢谢你的来信]" + msg + "\n");
