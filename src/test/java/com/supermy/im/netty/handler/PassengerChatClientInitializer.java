 ...
 * @author moyong
 */
public class PassengerChatClientInitializer extends ChannelInitializer<SocketChannel> {
    private final SslContext sslCtx;

    public PassengerChatClientInitializer(SslContext sslCtx) {
        this.sslCtx = sslCtx;
    }
    ...
    public void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("handler", new PassengerChatClientHandler());
    }
}
